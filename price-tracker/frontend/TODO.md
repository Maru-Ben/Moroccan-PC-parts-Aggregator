...
- Add a search bar in the search page to search other stuff.
- change the logo in the footer to be the same as the hexagon in the header.
- when clicking on categories in the top nav bar it should scroll down to shop by category section.
